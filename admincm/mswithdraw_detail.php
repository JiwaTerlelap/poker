...
$qr1 = mysqli_query(fOpenConn(), "SELECT * FROM msmember, mswithdraw, msgames WHERE mbr_games = gm_id AND wed_status = 'Baru' AND wed_member = mbr_id AND wed_id = '$id'");
...
$titlepage = "Withdraw Baru Detail";
if (isset($_POST['saveproses']))
{
    
        mysqli_query(fOpenConn(), "UPDATE mswithdraw SET wed_status = 'Setuju', wed_handleby = '$fix_username' WHERE wed_id = '$id'");
        ?>
        <script>
            alert("Success ::: Confirm Withdraw Baru");
            location.href = "mswithdraw.php";
        </script>
        <?php
    ...
    <div class="box col-md-8">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i> Detail Withdraw Baru</h2>
            ...
            <div class="box-content">
                <form role="form" action="" method="post" style="overflow: hidden;">
                    ...
                    <div class="form-group">
                      <label class="control-label col-sm-3" for="email">Jumlah Withdraw :</label>
                      <div class="control-label1 col-sm-9">
                        Rp. <?php echo $deposit; ?>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-sm-3" for="email">IP Withdraw :</label>
                      <div class="control-label1 col-sm-9">
                        <?php echo $ipdepo; ?>
                      </div>
                    </div>
